...
To replicate these tests you can either test using the .side test file using Selenium, or to test using your IDE the Chrome Driver and Google Chrome will need to be installed.
